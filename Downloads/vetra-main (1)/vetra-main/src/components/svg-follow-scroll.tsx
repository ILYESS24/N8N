...
const Skiper19 = () => {
  ...
  return (
    <section
      ref={ref}
      className="mx-auto flex h-[350vh] w-screen flex-col items-center overflow-hidden bg-white px-4 text-gray-900"
    >
      <div className="mt-42 relative flex w-fit flex-col items-center justify-center gap-5 text-center">
        <h1 className="relative z-10 text-7xl font-normal tracking-[-0.08em] lg:text-9xl text-gray-900">
          The Stroke <br /> That follows the <br />
          Scroll Progress
        </h1>
        <p className="relative z-10 max-w-2xl text-xl font-normal text-gray-600">
      ...
      <div className="rounded-4xl w-full translate-y-[200vh] bg-black pb-10 text-white">
