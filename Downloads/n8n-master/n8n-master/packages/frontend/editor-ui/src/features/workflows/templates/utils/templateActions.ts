...
import type { ITemplatesWorkflowFull, IWorkflowTemplate } from '@workflow-automation/rest-api-client/api/templates';
...
import type { useRootStore } from '@workflow-automation/stores/useRootStore';
