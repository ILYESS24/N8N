...
import * as provisioningApi from '@workflow-automation/rest-api-client/api/provisioning';
import type { ProvisioningConfig } from '@workflow-automation/rest-api-client/api/provisioning';
